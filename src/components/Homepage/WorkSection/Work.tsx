...
export default function Work() {
  return (
    <>
      ...
      >
        <p className="mb-8 w-full text-left text-4xl font-bold">Work</p>
        <div
          id="WorkContainer"
          className="flex w-full flex-col items-start justify-center gap-y-12"
        >
          <div id="WorkCard" className="mx-auto w-full text-base">
            <p className="mb-4 font-bold">Legio Vox Studios</p>
